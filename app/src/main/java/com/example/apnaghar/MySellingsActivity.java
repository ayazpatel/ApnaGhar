...
public class MySellingsActivity extends AppCompatActivity {
    ...
    private void fetchDataFromAPI() {
        String apiUrl = "https://et.ayafitech.com/api/my_sellings.php?email="+receivedemail;
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(
                        ...
                        try {
                            ...
                            adapter.setOnItemClickListener(new MySellingsAdapter.OnItemClickListener() {
                                ...
                                public void onItemClick(int position) {
                                    ...
                                    Toast.makeText(MySellingsActivity.this, "Clicked item ID: " + clickedItem.getId(), Toast.LENGTH_SHORT).show();
                                                ...
                                                public void onResponse(JSONObject response) {
                                                    try {
                                                        ...
                                                        if ("success".equals(status)) {
                                                            Toast.makeText(MySellingsActivity.this, message, Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        error.printStackTrace();
                        Toast.makeText(MySellingsActivity.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
        );
